                        ...
                        <div class="map-content-9 mt-lg-0 mt-4">
                            ...
                            <form method="post" name="changepassword" onsubmit="return checkpass();">
                                ...
                                <div style="padding-top: 30px;">
                                    ...
                                    <div id="passwordError" style="color: red; display: none;">Password must be 8-20
                                        characters long, contain at least one uppercase letter, one number, and one special
                                        character.</div>
                                    ...
                                    <script>
                                        document.getElementById('newpassword').addEventListener('input', function () {
                                            ...
                                            let passwordPattern = /^(?=.*[A-Z])(?=.*\d)(?=.*[\W_]).{8,20}$/;
